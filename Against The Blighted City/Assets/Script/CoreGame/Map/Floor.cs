...
public class Floor : MonoBehaviour
{
    ...
    public void SetNodesActive(Encounter _encounter)
    {
        ...
        //horizontalLayoutGroup.padding.left = 1;
        //this.gameObject.GetComponent<RectTransform>().sizeDelta = new Vector2((float) 0.6, Random.Range((float) 0.8, (float) 1.2));
        activeNodes.Clear();
        nodes.Shuffle();
        EnableNode(nodes[0]);
    ...
    {
        n.enabled = true;
        if (encounter.encounterSprite != null) { n.sprite = encounter.encounterSprite; }
        activeNodes.Add(n);
    }
